 ...
 * @author kimidori
 */
public class FeatureGeneratorMergeCB_20180511 implements FeatureGenerator{
	...
	public ArrayList<String> getResourceFilePath(){
		String treefile="resources/cbpred_noresinfo/tree_simple.0.dat";
		String scorefile="resources/cbpred_noresinfo/scores.0.dat";
	...
	FeatureGeneratorMergeCB_20180511(){
	...
	public static ArrayList<String> countAtoms_PDB(String treefile,File[] lis){
		...
		for(File f:lis){
			...
			FeatureGeneratorMergeCB_20180511 gen = new FeatureGeneratorMergeCB_20180511();
...
//trueatom_predictedas ALA_CB@5:	ALA_CB	342	GLY_PCB	197	SER_CB	108	LEU_CB	63	PHE_CB	48	VAL_CB	44	THR_CB	43	PRO_CB	40	TYR_CB	35	CYS_CB	28	ILE_CB	24	MET_CB	17	HIS_CB	17	ASN_CB	16	ASP_CB	16	LYS_CB	15	GLN_CB	12	TRP_CB	12	GLU_CB	10	ARG_CB	3
	...
	public static void makeScoreTable(String[] args){
		...
		"C:\\dummy\\vbox_share\\bioo\\database\\for_energyfunction\\14_jumpcb_noresinfo\\0511\\tree_simple.0.dat_0"
		,"C:\\dummy\\vbox_share\\bioo\\database\\for_energyfunction\\14_jumpcb_noresinfo\\0511\\table_merged.dat");
		for(String s:res){
		...
		printStrings("C:\\dummy\\vbox_share\\bioo\\database\\for_energyfunction\\14_jumpcb_noresinfo\\0511\\scores.0.dat_b",dres);
		
	}
	public static void makeInputTable(String[] args){
		String outfilename = "C:\\dummy\\vbox_share\\bioo\\database\\for_energyfunction\\14_jumpcb_noresinfo\\table_merged.dat";
		String sampledirname = "C:\\dummy\\vbox_share\\bioo\\database\\for_energyfunction\\onechain_plain_filtered\\";
		try{
			PrintWriter pw = new PrintWriter(new BufferedWriter(
			new OutputStreamWriter(new FileOutputStream(outfilename,false),"UTF-8"))); 
			...
			ArrayList<String> header = FeatureGeneratorMergeCB_20180511.getHeader();
			pw.write("name\t");
			for(String h:header){
				pw.write(h+"\t");
			}
