...
impl AtomDistanceEnergy{
    ...
    pub fn assign_atom_ids(mdenv:&ff_env::FFEnv,distdata:Vec<(String,usize,String,usize,AtomDistanceEnergy)>)->Vec<AtomDistanceEnergy>{
...
impl AtomBinnedDistanceEnergy{
    pub fn assign_atom_ids(mdenv:&ff_env::FFEnv,distdata:Vec<(String,usize,String,usize,AtomBinnedDistanceEnergy)>)->Vec<AtomBinnedDistanceEnergy>{
