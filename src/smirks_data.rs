...
lazy_static! {
    pub static ref ELEMENT_NUM_TO_NAME:HashMap<String,String> = 
    {
        let element_vec:Vec<&str> = vec!["#1","H","#2","He","#3","Li","#4","Be","#5","B","#6","C","#7","N","#8","O","#9","F","#10","Ne","#11","Na","#12","Mg","#13","Al","#14","Si","#15","P","#16","S","#17","Cl","#18","Ar","#19","K","#20","Ca","#21","Sc","#22","Ti","#23","V","#24","Cr"
        ...
        let slen:usize = element_vec.len();
        for ii in (0..slen).step_by(2) {
            m.insert(element_vec[ii+1].to_string(), element_vec[ii].to_string());
        }
        m
    };
    pub static ref ELEMENT_NAME_TO_NUM:HashMap<String,String> = 
    {
        let element_vec:Vec<&str> = vec!["#1","H","#2","He","#3","Li","#4","Be","#5","B","#6","C","#7","N","#8","O","#9","F","#10","Ne","#11","Na","#12","Mg","#13","Al","#14","Si","#15","P","#16","S","#17","Cl","#18","Ar","#19","K","#20","Ca","#21","Sc","#22","Ti","#23","V","#24","Cr"
        ,"#25","Mn","#26","Fe","#27","Co","#28","Ni","#29","Cu","#30","Zn","#31","Ga","#32","Ge","#33","As","#34","Se","#35","Br","#36","Kr","#55","Cs","#56","Ba","#72","Hf","#73","Ta","#74","W","#75","Re","#76","Os","#77","Ir","#78","Pt","#79","Au"
        ,"#80","Hg","#81","Tl","#82","Pb","#83","Bi","#84","Po","#85","At","#86","Rn","#87","Fr","#88","Ra","#104","Rf","#105","Db","#106","Sg","#107","Bh","#108","Hs","#109","Mt","#110","Ds","#111","Rg","#112","Cn","#113","Nh","#114","Fl","#115","Mc"
        ...
        let slen:usize = element_vec.len();
        for ii in (0..slen).step_by(2) {
            m.insert(element_vec[ii].to_string(), element_vec[ii+1].to_string());
        }
        m
    };
}
